...
<body>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0">Não tem conta? <a href="">Procure o RH</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    if (isset($_POST['nome'])) 
    {
        ...
        if (!empty($nome) && !empty($telefone) && !empty($email) && !empty($senha) && !empty($confirmarSenha)) 
        {
            ...
            if ($u->msgErro == "") //não houve erro esta ok
            {
                if ($senha == $confirmarSenha) //verificando se senha e confirmar senha são iguais
                {
                ...
                } else 
                {
                    ?>
                    <div class="msg-erro">
                        Opss ! A senha e o confirmar senha não são idênticos
                    </div>
                    <?php
                }
            } else 
        ...
        } else 
        {
            ?>
            <div class="msg-erro">
                Preecha todos os campos do formulário
            </div>
            <?php
        }
    }
